        ...
        <main className="w-full h-screen flex-col p-4 justify-between items-center flex bg-[#161616] ">
            ...
            <article className="shadow-lg w-md p-6 font-bold text-white rounded -outline-offset-1 outline outline-white/10 bg-[#111111]">
                <div className="mb-4">
                    ...
                    <p className="text-sm font-normal">Rastreando a sua vida.</p>
                </div>
                <form className="font-normal flex flex-col gap-2">
                    ...
                    <div className="text-sm flex gap-2 items-center">
                        ...
                        <a className="opacity-70">Lembrar do meu login</a>
                    </div>
                    <Link to={'/app'}  className="mt-2 text-center -outline-offset-1 outline cursor-pointer outline-white/10 py-2 w-full hover:bg-neutral-900 transition-all rounded">Acessar o seu Routini</Link>
                </form>
